...
cd /root && wget http://raw.githubusercontent.com/marconimp/xtreamcodes_1.0.60/master/go.part01.rar
...
cp -R /root/go/Xtream_Codes_v1.0.60_Nulled.zip  /var/www/html/
...
rm /root/go/
rm /root/go.part01.rar
rm /root/go.part02.rar
rm /root/go.part03.rar
rm /root/go.part04.rar
rm /root/go.part05.rar
rm /root/go.part06.rar
rm /root/go.part07.rar
rm /root/go.part08.rar
rm /root/go.part09.rar
